...
// ============================================================================
// Function: rsb_refilling_bp
// description:
//   - This technique removes the $A_{inv}$, $A_{pc}$, $A_{alias}$ operations
//     for the RSB from the three-step branch predictor.
// ============================================================================
fn rsb_refilling_bp() {
    println!("RSB Refilling");
    ...
    simulator::simulator(rsb_exlude_states, "RSB".to_string(), false);
}
...
fn lock_bp() {
    ...
    simulator::simulator(pht_exlude_states, "PHT".to_string(), false);
    ...
    simulator::simulator(btb_ind_exlude_states, "BTB (ind)".to_string(), false);
    ...
    simulator::simulator(btb_call_exlude_states, "BTB (call)".to_string(), false);
    ...
    simulator::simulator(btb_ret_exlude_states, "BTB (ret)".to_string(), false);
...
// ============================================================================
// Function: exp2_rsb_refilling
// description:
//   - This function is used to evaluate the RSB refilling.
// ============================================================================
pub fn exp2_rsb_refilling() {
    println!("========= BP-SEC-SIM =========");
    rsb_refilling_bp();
    println!("== DONE!: BP-SEC-SIM (exp2) ==");
    println!("\n");
}

// ============================================================================
// Function: exp2_secure_bp
// description:
//   - This function is used to evaluate the security of 8 existing secure
//     branch predictors (with RSB refilling).
// ============================================================================
pub fn exp2_secure_bp() {
    println!("========= BP-SEC-SIM =========");
    lock_bp();
    println!("==============================");
    brb_bp();
